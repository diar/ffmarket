...
<xsl:stylesheet version="1.0"
            ...
            <div class="caption">
                ...
                <div id="registration_form" class="ajax_form form_dialog">
                    ...
                    <div style="padding:15px 0">
                        ...
                        <span >ознакомлен с </span><a href="#">правилами</a>
                    </div>
    ...
    <xsl:template name="discount_dialog">
        <div id="discount_dialog" class="dialog_box dialog box_shadow">
            ...
            <div style="text-align:center;font-size:11px; margin-bottom:5px;">Скидка бесплатна иa действительна в течении 24 часов при предъявлении SMS официанту. <a href="#">Правила</a>.</div>
        </div>
    </xsl:template>
    ...
    <xsl:template name="order_dialog">
        <div id="order_dialog" class="dialog_box dialog box_shadow">
            <div class="caption">
                <img class="close_button" src="/public/images/icons/close_icon.jpg" alt="закрыть" />
                <div class="clear"></div>
